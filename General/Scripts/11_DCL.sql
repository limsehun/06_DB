 ...
 * 
 * - 계정별로 DB또는 DB객체에 대한 접근(제어) 권한을 부여(GRANT), 회수(REVOKE)하는 언어
 * 
 * */
...
GRANT CREATE SESSION TO TEST_USER;
  ...
  * 
  * --> 객체를 생성 할 수 있는 공간(TABLESPACE) 할당 + 기본 객체 제어 권한 부여
  * 
  * */
...
/* TEST_USER 접속해서 SSELECT 확인 */

SELECT * FROM KH_LSH.EMPLOYEE; -- 조회결과
