 ...
 * 
 *  4) WITH CHECK OPTION 옵션 : (밑에거에 비슷한 기능 있어서 잘 안 씀 )
...
-- 사번, 이름, 부서명, 직급명을 쉽게 조회하기 위한 VIEW생성

-- 기존의 객체가 이름을 사용하고 있습니다.
--> OR REPLACE옵션을 사용해서 해결
...
ORDER BY 사번 ASC;--(요건 SELECT다음? 거의 마지막 꼭 기억해야해)
...
-- DEPARTMENT 테이블을 복사한 DEPT_COPT2 생성
...
WHERE TEST_ID = 'TEST500000';-- 0.018
